...
export default class Drivemap extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    let { start, end, BMap } = this.state,
      map = new BMap.Map("drivebox");             // 创建地图实例
    ...
    return (
      <Wrapper>
        <div className="mapContainer">
          <div id="drivebox" className="drivebox"></div>
        </div>
